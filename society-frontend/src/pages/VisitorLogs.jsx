...
const VisitorLogs = () => {
  ...
  return (
    <div className="p-6 min-h-screen bg-gradient-to-br from-yellow-50 to-white">
      ...
      {error && (
        <motion.div
          className="text-red-600 bg-red-50 border border-red-200 rounded p-3 text-center mb-4"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        >
          {error}
      ...
      {!error && visitors.length === 0 ? (
        ...
        >
          <table className="min-w-full bg-white rounded-lg text-sm">
            <thead className="bg-yellow-100 text-yellow-900 uppercase text-xs tracking-wide">
              <tr>
